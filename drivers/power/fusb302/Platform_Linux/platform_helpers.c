...
FSC_S32 fusb_InitializeGPIO(void)
{
    ...
    printk("fub302 func=%s,line=%d\n",__func__,__LINE__);
    if (!chip)
    {
        printk(" fusb302 FUSB  %s - Error: Chip structure is NULL!\n", __func__);
        return -ENOMEM;
    }
    ...
    {
        printk("fusb302 %s - Error: Could not get named GPIO for Int_N! Error code: %d\n", __func__, chip->gpio_IntN);
    ...
    if (ret < 0)
    {
        printk("fusb302 %s - Error: Could not request GPIO for Int_N! Error code: %d\n", __func__, ret);
        return ret;
    }
    ...
    if (ret < 0)
    {
        printk("fusb302 %s - Error: Could not set GPIO direction to input for Int_N! Error code: %d\n", __func__, ret);
        return ret;
    }
    ...
    {
        printk("fusb302 %s - Error: Could not get named GPIO for VBus5V! Error code: %d\n", __func__, chip->gpio_VBus5V);
        fusb_GPIO_Cleanup();
    ...
    if (ret < 0)
    {
        printk("fusb302 %s - Error: Could not request GPIO for VBus5V! Error code: %d\n", __func__, ret);
        return ret;
    }
    ...
    if (ret < 0)
    {
        printk("fusb302 %s - Error: Could not set GPIO direction to output for VBus5V! Error code: %d\n", __func__, ret);
        fusb_GPIO_Cleanup();
        return ret;
    }
    ...
    else
    {
        ...
        if (ret < 0)
        {
            printk("fusb302 %s - Error: Could not request GPIO for VBusOther! Error code: %d\n", __func__, ret);
            return ret;
        }
        ...
        if (ret != 0)
        {
            printk("fusb302 %s - Error: Could not set GPIO direction to output for VBusOther! Error code: %d\n", __func__, ret);
            return ret;
        }
        else
        {
    ...
    else
    {
        ...
        if (ret < 0)
        {
            printk("fusb302 %s - Error: Could not request GPIO for Debug GPIO! Error code: %d\n", __func__, ret);
            return ret;
        }
        ...
        if (ret != 0)
        {
            printk("fusb302 %s - Error: Could not set GPIO direction to output for Debug GPIO! Error code: %d\n", __func__, ret);
            return ret;
        }
        else
        {
...
void fusb_GPIO_Set_VBus5v(FSC_BOOL set)
{
    ...
    if (gpio_cansleep(chip->gpio_VBus5V))
    {
         ...
         */
        gpio_set_value_cansleep(chip->gpio_VBus5V, set ? 0 : 1);//set ? 1 : 0 //add by longcheer_liml
    }
    else
    {
        gpio_set_value(chip->gpio_VBus5V, set ? 0 : 1);//set ? 1 : 0 //add by longcheer_liml
    }
    chip->gpio_VBus5V_value = set;

    printk("fusb302 FUSB  %s - VBus 5V set to: %d\n", __func__, chip->gpio_VBus5V_value ? 0 : 1);
}
...
FSC_BOOL fusb_GPIO_Get_VBus5v(void)
{
    ...
    if (!gpio_is_valid(chip->gpio_VBus5V))
    {
        printk("fusb302 FUSB  %s - Error: VBus 5V pin invalid! Pin value: %d\n", __func__, chip->gpio_VBus5V);
    }
...
FSC_BOOL fusb_I2C_WriteData(FSC_U8 address, FSC_U8 length, FSC_U8* data)
{
    ...
    for (i = 0; i <= chip->numRetriesI2C; i++)
    {
        ...
        {
            if (ret == -ERANGE) { printk("fusb302 %s - I2C Error block writing byte data. Address: '0x%02x', Return: -ERANGE.  Attempt #%d / %d...\n", __func__, address, i, chip->numRetriesI2C); }
            else if (ret == -EINVAL) { printk("fusb302 %s - I2C Error block writing byte data. Address: '0x%02x', Return: -EINVAL.  Attempt #%d / %d...\n", __func__, address, i, chip->numRetriesI2C); }
            else if (ret == -EAGAIN) { printk("fusb302 %s - I2C Error block writing byte data. Address: '0x%02x', Return: -EAGAIN.  Attempt #%d / %d...\n", __func__, address, i, chip->numRetriesI2C); }
            else if (ret == -EALREADY) { printk("fusb302 %s - I2C Error block writing byte data. Address: '0x%02x', Return: -EALREADY.  Attempt #%d / %d...\n", __func__, address, i, chip->numRetriesI2C); }
            else if (ret == -EBADE) { printk("fusb302 %s - I2C Error block writing byte data. Address: '0x%02x', Return: -EBADE.  Attempt #%d / %d...\n", __func__, address, i, chip->numRetriesI2C); }
            else if (ret == -EBADMSG) { printk("fusb302 %s - I2C Error block writing byte data. Address: '0x%02x', Return: -EBADMSG.  Attempt #%d / %d...\n", __func__, address, i, chip->numRetriesI2C); }
            else if (ret == -EBUSY) { printk("fusb302 %s - I2C Error block writing byte data. Address: '0x%02x', Return: -EBUSY.  Attempt #%d / %d...\n", __func__, address, i, chip->numRetriesI2C); }
            else if (ret == -ECANCELED) { printk("fusb302 %s - I2C Error block writing byte data. Address: '0x%02x', Return: -ECANCELED.  Attempt #%d / %d...\n", __func__, address, i, chip->numRetriesI2C); }
            else if (ret == -ECOMM) { printk("fusb302 %s - I2C Error block writing byte data. Address: '0x%02x', Return: -ECOMM.  Attempt #%d / %d...\n", __func__, address, i, chip->numRetriesI2C); }
            else if (ret == -ECONNABORTED) { printk("fusb302 %s - I2C Error block writing byte data. Address: '0x%02x', Return: -ECONNABORTED.  Attempt #%d / %d...\n", __func__, address, i, chip->numRetriesI2C); }
            else if (ret == -ECONNREFUSED) { printk("fusb302 %s - I2C Error block writing byte data. Address: '0x%02x', Return: -ECONNREFUSED.  Attempt #%d / %d...\n", __func__, address, i, chip->numRetriesI2C); }
            else if (ret == -ECONNRESET) { printk("fusb302 %s - I2C Error block writing byte data. Address: '0x%02x', Return: -ECONNRESET.  Attempt #%d / %d...\n", __func__, address, i, chip->numRetriesI2C); }
            else if (ret == -EDEADLK) { printk("fusb302 %s - I2C Error block writing byte data. Address: '0x%02x', Return: -EDEADLK.  Attempt #%d / %d...\n", __func__, address, i, chip->numRetriesI2C); }
            else if (ret == -EDEADLOCK) { printk("fusb302 %s - I2C Error block writing byte data. Address: '0x%02x', Return: -EDEADLOCK.  Attempt #%d / %d...\n", __func__, address, i, chip->numRetriesI2C); }
            else if (ret == -EDESTADDRREQ) { printk("fusb302 %s - I2C Error block writing byte data. Address: '0x%02x', Return: -EDESTADDRREQ.  Attempt #%d / %d...\n", __func__, address, i, chip->numRetriesI2C); }
            else if (ret == -EFAULT) { printk("fusb302 %s - I2C Error block writing byte data. Address: '0x%02x', Return: -EFAULT.  Attempt #%d / %d...\n", __func__, address, i, chip->numRetriesI2C); }
            else if (ret == -EHOSTDOWN) { printk("fusb302 %s - I2C Error block writing byte data. Address: '0x%02x', Return: -EHOSTDOWN.  Attempt #%d / %d...\n", __func__, address, i, chip->numRetriesI2C); }
            else if (ret == -EHOSTUNREACH) { printk("fusb302 %s - I2C Error block writing byte data. Address: '0x%02x', Return: -EHOSTUNREACH.  Attempt #%d / %d...\n", __func__, address, i, chip->numRetriesI2C); }
            else if (ret == -EILSEQ) { printk("fusb302 %s - I2C Error block writing byte data. Address: '0x%02x', Return: -EILSEQ.  Attempt #%d / %d...\n", __func__, address, i, chip->numRetriesI2C); }
            else if (ret == -EINPROGRESS) { printk("fusb302 %s - I2C Error block writing byte data. Address: '0x%02x', Return: -EINPROGRESS.  Attempt #%d / %d...\n", __func__, address, i, chip->numRetriesI2C); }
            else if (ret == -EINTR) { printk("fusb302 %s - I2C Error block writing byte data. Address: '0x%02x', Return: -EINTR.  Attempt #%d / %d...\n", __func__, address, i, chip->numRetriesI2C); }
            else if (ret == -EIO) { printk("fusb302 %s - I2C Error block writing byte data. Address: '0x%02x', Return: -EIO.  Attempt #%d / %d...\n", __func__, address, i, chip->numRetriesI2C); }
            else if (ret == -ELIBACC) { printk("fusb302 %s - I2C Error block writing byte data. Address: '0x%02x', Return: -ELIBACC.  Attempt #%d / %d...\n", __func__, address, i, chip->numRetriesI2C); }
            else if (ret == -ELIBBAD) { printk("fusb302 %s - I2C Error block writing byte data. Address: '0x%02x', Return: -ELIBBAD.  Attempt #%d / %d...\n", __func__, address, i, chip->numRetriesI2C); }
            else if (ret == -ELIBMAX) { printk("fusb302 %s - I2C Error block writing byte data. Address: '0x%02x', Return: -ELIBMAX.  Attempt #%d / %d...\n", __func__, address, i, chip->numRetriesI2C); }
            else if (ret == -ELOOP) { printk("fusb302 %s - I2C Error block writing byte data. Address: '0x%02x', Return: -ELOOP.  Attempt #%d / %d...\n", __func__, address, i, chip->numRetriesI2C); }
            else if (ret == -EMSGSIZE) { printk("fusb302 %s - I2C Error block writing byte data. Address: '0x%02x', Return: -EMSGSIZE.  Attempt #%d / %d...\n", __func__, address, i, chip->numRetriesI2C); }
            else if (ret == -EMULTIHOP) { printk("fusb302 %s - I2C Error block writing byte data. Address: '0x%02x', Return: -EMULTIHOP.  Attempt #%d / %d...\n", __func__, address, i, chip->numRetriesI2C); }
            else if (ret == -ENOBUFS) { printk("fusb302 %s - I2C Error block writing byte data. Address: '0x%02x', Return: -ENOBUFS.  Attempt #%d / %d...\n", __func__, address, i, chip->numRetriesI2C); }
            else if (ret == -ENODATA) { printk("fusb302 %s - I2C Error block writing byte data. Address: '0x%02x', Return: -ENODATA.  Attempt #%d / %d...\n", __func__, address, i, chip->numRetriesI2C); }
            else if (ret == -ENODEV) { printk("fusb302 %s - I2C Error block writing byte data. Address: '0x%02x', Return: -ENODEV.  Attempt #%d / %d...\n", __func__, address, i, chip->numRetriesI2C); }
            else if (ret == -ENOLCK) { printk("fusb302 %s - I2C Error block writing byte data. Address: '0x%02x', Return: -ENOLCK.  Attempt #%d / %d...\n", __func__, address, i, chip->numRetriesI2C); }
            else if (ret == -ENOMEM) { printk("fusb302 %s - I2C Error block writing byte data. Address: '0x%02x', Return: -ENOMEM.  Attempt #%d / %d...\n", __func__, address, i, chip->numRetriesI2C); }
            else if (ret == -ENOMSG) { printk("fusb302 %s - I2C Error block writing byte data. Address: '0x%02x', Return: -ENOMSG.  Attempt #%d / %d...\n", __func__, address, i, chip->numRetriesI2C); }
            else if (ret == -ENOPROTOOPT) { printk("fusb302 %s - I2C Error block writing byte data. Address: '0x%02x', Return: -ENOPROTOOPT.  Attempt #%d / %d...\n", __func__, address, i, chip->numRetriesI2C); }
            else if (ret == -ENOSPC) { printk("fusb302 %s - I2C Error block writing byte data. Address: '0x%02x', Return: -ENOSPC.  Attempt #%d / %d...\n", __func__, address, i, chip->numRetriesI2C); }
            else if (ret == -ENOSYS) { printk("fusb302 %s - I2C Error block writing byte data. Address: '0x%02x', Return: -ENOSYS.  Attempt #%d / %d...\n", __func__, address, i, chip->numRetriesI2C); }
            else if (ret == -ENOTBLK) { printk("fusb302 %s - I2C Error block writing byte data. Address: '0x%02x', Return: -ENOTBLK.  Attempt #%d / %d...\n", __func__, address, i, chip->numRetriesI2C); }
            else if (ret == -ENOTTY) { printk("fusb302 %s - I2C Error block writing byte data. Address: '0x%02x', Return: -ENOTTY.  Attempt #%d / %d...\n", __func__, address, i, chip->numRetriesI2C); }
            else if (ret == -ENOTUNIQ) { printk("fusb302 %s - I2C Error block writing byte data. Address: '0x%02x', Return: -ENOTUNIQ.  Attempt #%d / %d...\n", __func__, address, i, chip->numRetriesI2C); }
            else if (ret == -ENXIO) { printk("fusb302 %s - I2C Error block writing byte data. Address: '0x%02x', Return: -ENXIO.  Attempt #%d / %d...\n", __func__, address, i, chip->numRetriesI2C); }
            else if (ret == -EOVERFLOW) { printk("fusb302 %s - I2C Error block writing byte data. Address: '0x%02x', Return: -EOVERFLOW.  Attempt #%d / %d...\n", __func__, address, i, chip->numRetriesI2C); }
            else if (ret == -EPERM) { printk("fusb302 %s - I2C Error block writing byte data. Address: '0x%02x', Return: -EPERM.  Attempt #%d / %d...\n", __func__, address, i, chip->numRetriesI2C); }
            else if (ret == -EPFNOSUPPORT) { printk("fusb302 %s - I2C Error block writing byte data. Address: '0x%02x', Return: -EPFNOSUPPORT.  Attempt #%d / %d...\n", __func__, address, i, chip->numRetriesI2C); }
            else if (ret == -EPIPE) { printk("fusb302 %s - I2C Error block writing byte data. Address: '0x%02x', Return: -EPIPE.  Attempt #%d / %d...\n", __func__, address, i, chip->numRetriesI2C); }
            else if (ret == -EPROTO) { printk("fusb302 %s - I2C Error block writing byte data. Address: '0x%02x', Return: -EPROTO.  Attempt #%d / %d...\n", __func__, address, i, chip->numRetriesI2C); }
            else if (ret == -EPROTONOSUPPORT) { printk("fusb302 %s - I2C Error block writing byte data. Address: '0x%02x', Return: -EPROTONOSUPPORT.  Attempt #%d / %d...\n", __func__, address, i, chip->numRetriesI2C); }
            else if (ret == -ERANGE) { printk("fusb302 %s - I2C Error block writing byte data. Address: '0x%02x', Return: -ERANGE.  Attempt #%d / %d...\n", __func__, address, i, chip->numRetriesI2C); }
            else if (ret == -EREMCHG) { printk("fusb302 %s - I2C Error block writing byte data. Address: '0x%02x', Return: -EREMCHG.  Attempt #%d / %d...\n", __func__, address, i, chip->numRetriesI2C); }
            else if (ret == -EREMOTE) { printk("fusb302 %s - I2C Error block writing byte data. Address: '0x%02x', Return: -EREMOTE.  Attempt #%d / %d...\n", __func__, address, i, chip->numRetriesI2C); }
            else if (ret == -EREMOTEIO) { printk("fusb302 %s - I2C Error block writing byte data. Address: '0x%02x', Return: -EREMOTEIO.  Attempt #%d / %d...\n", __func__, address, i, chip->numRetriesI2C); }
            else if (ret == -ERESTART) { printk("fusb302 %s - I2C Error block writing byte data. Address: '0x%02x', Return: -ERESTART.  Attempt #%d / %d...\n", __func__, address, i, chip->numRetriesI2C); }
            else if (ret == -ESRCH) { printk("fusb302 %s - I2C Error block writing byte data. Address: '0x%02x', Return: -ESRCH.  Attempt #%d / %d...\n", __func__, address, i, chip->numRetriesI2C); }
            else if (ret == -ETIME) { printk("fusb302 %s - I2C Error block writing byte data. Address: '0x%02x', Return: -ETIME.  Attempt #%d / %d...\n", __func__, address, i, chip->numRetriesI2C); }
            else if (ret == -ETIMEDOUT) { printk("fusb302 %s - I2C Error block writing byte data. Address: '0x%02x', Return: -ETIMEDOUT.  Attempt #%d / %d...\n", __func__, address, i, chip->numRetriesI2C); }
            else if (ret == -ETXTBSY) { printk("fusb302 %s - I2C Error block writing byte data. Address: '0x%02x', Return: -ETXTBSY.  Attempt #%d / %d...\n", __func__, address, i, chip->numRetriesI2C); }
            else if (ret == -EUCLEAN) { printk("fusb302 %s - I2C Error block writing byte data. Address: '0x%02x', Return: -EUCLEAN.  Attempt #%d / %d...\n", __func__, address, i, chip->numRetriesI2C); }
            else if (ret == -EUNATCH) { printk("fusb302 %s - I2C Error block writing byte data. Address: '0x%02x', Return: -EUNATCH.  Attempt #%d / %d...\n", __func__, address, i, chip->numRetriesI2C); }
            else if (ret == -EUSERS) { printk("fusb302 %s - I2C Error block writing byte data. Address: '0x%02x', Return: -EUSERS.  Attempt #%d / %d...\n", __func__, address, i, chip->numRetriesI2C); }
            else if (ret == -EWOULDBLOCK) { printk("fusb302 %s - I2C Error block writing byte data. Address: '0x%02x', Return: -EWOULDBLOCK.  Attempt #%d / %d...\n", __func__, address, i, chip->numRetriesI2C); }
            else if (ret == -EXDEV) { printk("fusb302 %s - I2C Error block writing byte data. Address: '0x%02x', Return: -EXDEV.  Attempt #%d / %d...\n", __func__, address, i, chip->numRetriesI2C); }
            else if (ret == -EXFULL) { printk("fusb302 %s - I2C Error block writing byte data. Address: '0x%02x', Return: -EXFULL.  Attempt #%d / %d...\n", __func__, address, i, chip->numRetriesI2C); }
            else if (ret == -EOPNOTSUPP) { printk("fusb302 %s - I2C Error writing byte data. Address: '0x%02x', Return: -EOPNOTSUPP.  Attempt #%d / %d...\n", __func__, address, i, chip->numRetriesI2C); }
            else if (ret == -EPROBE_DEFER) { printk("fusb302 %s - I2C Error writing byte data. Address: '0x%02x', Return: -EPROBE_DEFER.  Attempt #%d / %d...\n", __func__, address, i, chip->numRetriesI2C); }
            else if (ret == -ENOENT) { printk("fusb302 %s - I2C Error writing byte data. Address: '0x%02x', Return: -ENOENT.  Attempt #%d / %d...\n", __func__, address, i, chip->numRetriesI2C); }
            else { printk("fusb302 %s - Unexpected I2C error block writing byte data. Address: '0x%02x', Return: '%d'.  Attempt #%d / %d...\n", __func__, address, ret, i, chip->numRetriesI2C); }
        }
...
FSC_BOOL fusb_I2C_ReadData(FSC_U8 address, FSC_U8* data)
{
    ...
    for (i = 0; i <= chip->numRetriesI2C; i++)
    {
        ...
        if (ret < 0)                                                            // Errors report as negative
        {
            if (ret == -ERANGE) { printk("fusb302 %s - I2C Error reading byte data. Address: '0x%02x', Return: -ERANGE.  Attempt #%d / %d...\n", __func__, address, i, chip->numRetriesI2C); }
            else if (ret == -EINVAL) { printk("fusb302 %s - I2C Error reading byte data. Address: '0x%02x', Return: -EINVAL.  Attempt #%d / %d...\n", __func__, address, i, chip->numRetriesI2C); }
            else if (ret == -EAGAIN) { printk("fusb302 %s - "
                                                                   " reading byte data. Address: '0x%02x', Return: -EAGAIN.  Attempt #%d / %d...\n", __func__, address, i, chip->numRetriesI2C); }
            else if (ret == -EALREADY) { printk("fusb302 %s - I2C Error reading byte data. Address: '0x%02x', Return: -EALREADY.  Attempt #%d / %d...\n", __func__, address, i, chip->numRetriesI2C); }
            else if (ret == -EBADE) { printk("fusb302 %s - I2C Error reading byte data. Address: '0x%02x', Return: -EBADE.  Attempt #%d / %d...\n", __func__, address, i, chip->numRetriesI2C); }
            else if (ret == -EBADMSG) { printk("fusb302 %s - I2C Error reading byte data. Address: '0x%02x', Return: -EBADMSG.  Attempt #%d / %d...\n", __func__, address, i, chip->numRetriesI2C); }
            else if (ret == -EBUSY) { printk("fusb302 %s - I2C Error reading byte data. Address: '0x%02x', Return: -EBUSY.  Attempt #%d / %d...\n", __func__, address, i, chip->numRetriesI2C); }
            else if (ret == -ECANCELED) { printk("fusb302 %s - I2C Error reading byte data. Address: '0x%02x', Return: -ECANCELED.  Attempt #%d / %d...\n", __func__, address, i, chip->numRetriesI2C); }
            else if (ret == -ECOMM) { printk("fusb302 %s - I2C Error reading byte data. Address: '0x%02x', Return: -ECOMM.  Attempt #%d / %d...\n", __func__, address, i, chip->numRetriesI2C); }
            else if (ret == -ECONNABORTED) { printk("fusb302 %s - I2C Error reading byte data. Address: '0x%02x', Return: -ECONNABORTED.  Attempt #%d / %d...\n", __func__, address, i, chip->numRetriesI2C); }
            else if (ret == -ECONNREFUSED) { printk("fusb302 %s - I2C Error reading byte data. Address: '0x%02x', Return: -ECONNREFUSED.  Attempt #%d / %d...\n", __func__, address, i, chip->numRetriesI2C); }
            else if (ret == -ECONNRESET) { printk("fusb302 %s - I2C Error reading byte data. Address: '0x%02x', Return: -ECONNRESET.  Attempt #%d / %d...\n", __func__, address, i, chip->numRetriesI2C); }
            else if (ret == -EDEADLK) { printk("fusb302 %s - I2C Error reading byte data. Address: '0x%02x', Return: -EDEADLK.  Attempt #%d / %d...\n", __func__, address, i, chip->numRetriesI2C); }
            else if (ret == -EDEADLOCK) { printk("fusb302 %s - I2C Error reading byte data. Address: '0x%02x', Return: -EDEADLOCK.  Attempt #%d / %d...\n", __func__, address, i, chip->numRetriesI2C); }
            else if (ret == -EDESTADDRREQ) { printk("fusb302 %s - I2C Error reading byte data. Address: '0x%02x', Return: -EDESTADDRREQ.  Attempt #%d / %d...\n", __func__, address, i, chip->numRetriesI2C); }
            else if (ret == -EFAULT) { printk("fusb302 %s - I2C Error reading byte data. Address: '0x%02x', Return: -EFAULT.  Attempt #%d / %d...\n", __func__, address, i, chip->numRetriesI2C); }
            else if (ret == -EHOSTDOWN) { printk("fusb302 %s - I2C Error reading byte data. Address: '0x%02x', Return: -EHOSTDOWN.  Attempt #%d / %d...\n", __func__, address, i, chip->numRetriesI2C); }
            else if (ret == -EHOSTUNREACH) { printk("fusb302 %s - I2C Error reading byte data. Address: '0x%02x', Return: -EHOSTUNREACH.  Attempt #%d / %d...\n", __func__, address, i, chip->numRetriesI2C); }
            else if (ret == -EILSEQ) { printk("fusb302 %s - I2C Error reading byte data. Address: '0x%02x', Return: -EILSEQ.  Attempt #%d / %d...\n", __func__, address, i, chip->numRetriesI2C); }
            else if (ret == -EINPROGRESS) { printk("fusb302 %s - I2C Error reading byte data. Address: '0x%02x', Return: -EINPROGRESS.  Attempt #%d / %d...\n", __func__, address, i, chip->numRetriesI2C); }
            else if (ret == -EINTR) { printk("fusb302 %s - I2C Error reading byte data. Address: '0x%02x', Return: -EINTR.  Attempt #%d / %d...\n", __func__, address, i, chip->numRetriesI2C); }
            else if (ret == -EIO) { printk("fusb302 %s - I2C Error reading byte data. Address: '0x%02x', Return: -EIO.  Attempt #%d / %d...\n", __func__, address, i, chip->numRetriesI2C); }
            else if (ret == -ELIBACC) { printk("fusb302 %s - I2C Error reading byte data. Address: '0x%02x', Return: -ELIBACC.  Attempt #%d / %d...\n", __func__, address, i, chip->numRetriesI2C); }
            else if (ret == -ELIBBAD) { printk("fusb302 %s - I2C Error reading byte data. Address: '0x%02x', Return: -ELIBBAD.  Attempt #%d / %d...\n", __func__, address, i, chip->numRetriesI2C); }
            else if (ret == -ELIBMAX) { printk("fusb302 %s - I2C Error reading byte data. Address: '0x%02x', Return: -ELIBMAX.  Attempt #%d / %d...\n", __func__, address, i, chip->numRetriesI2C); }
            else if (ret == -ELOOP) { printk("fusb302 %s - I2C Error reading byte data. Address: '0x%02x', Return: -ELOOP.  Attempt #%d / %d...\n", __func__, address, i, chip->numRetriesI2C); }
            else if (ret == -EMSGSIZE) { printk("fusb302 %s - I2C Error reading byte data. Address: '0x%02x', Return: -EMSGSIZE.  Attempt #%d / %d...\n", __func__, address, i, chip->numRetriesI2C); }
            else if (ret == -EMULTIHOP) { printk("fusb302 %s - I2C Error reading byte data. Address: '0x%02x', Return: -EMULTIHOP.  Attempt #%d / %d...\n", __func__, address, i, chip->numRetriesI2C); }
            else if (ret == -ENOBUFS) { printk("fusb302 %s - I2C Error reading byte data. Address: '0x%02x', Return: -ENOBUFS.  Attempt #%d / %d...\n", __func__, address, i, chip->numRetriesI2C); }
            else if (ret == -ENODATA) { printk("fusb302 %s - I2C Error reading byte data. Address: '0x%02x', Return: -ENODATA.  Attempt #%d / %d...\n", __func__, address, i, chip->numRetriesI2C); }
            else if (ret == -ENODEV) { printk("fusb302 %s - I2C Error reading byte data. Address: '0x%02x', Return: -ENODEV.  Attempt #%d / %d...\n", __func__, address, i, chip->numRetriesI2C); }
            else if (ret == -ENOLCK) { printk("fusb302 %s - I2C Error reading byte data. Address: '0x%02x', Return: -ENOLCK.  Attempt #%d / %d...\n", __func__, address, i, chip->numRetriesI2C); }
            else if (ret == -ENOMEM) { printk("fusb302 %s - I2C Error reading byte data. Address: '0x%02x', Return: -ENOMEM.  Attempt #%d / %d...\n", __func__, address, i, chip->numRetriesI2C); }
            else if (ret == -ENOMSG) { printk("fusb302 %s - I2C Error reading byte data. Address: '0x%02x', Return: -ENOMSG.  Attempt #%d / %d...\n", __func__, address, i, chip->numRetriesI2C); }
            else if (ret == -ENOPROTOOPT) { printk("fusb302 %s - I2C Error reading byte data. Address: '0x%02x', Return: -ENOPROTOOPT.  Attempt #%d / %d...\n", __func__, address, i, chip->numRetriesI2C); }
            else if (ret == -ENOSPC) { printk("fusb302 %s - I2C Error reading byte data. Address: '0x%02x', Return: -ENOSPC.  Attempt #%d / %d...\n", __func__, address, i, chip->numRetriesI2C); }
            else if (ret == -ENOSYS) { printk("fusb302 %s - I2C Error reading byte data. Address: '0x%02x', Return: -ENOSYS.  Attempt #%d / %d...\n", __func__, address, i, chip->numRetriesI2C); }
            else if (ret == -ENOTBLK) { printk("fusb302 %s - I2C Error reading byte data. Address: '0x%02x', Return: -ENOTBLK.  Attempt #%d / %d...\n", __func__, address, i, chip->numRetriesI2C); }
            else if (ret == -ENOTTY) { printk("fusb302 %s - I2C Error reading byte data. Address: '0x%02x', Return: -ENOTTY.  Attempt #%d / %d...\n", __func__, address, i, chip->numRetriesI2C); }
            else if (ret == -ENOTUNIQ) { printk("fusb302 %s - I2C Error reading byte data. Address: '0x%02x', Return: -ENOTUNIQ.  Attempt #%d / %d...\n", __func__, address, i, chip->numRetriesI2C); }
            else if (ret == -ENXIO) { printk("fusb302 %s - I2C Error reading byte data. Address: '0x%02x', Return: -ENXIO.  Attempt #%d / %d...\n", __func__, address, i, chip->numRetriesI2C); }
            else if (ret == -EOVERFLOW) { printk("fusb302 %s - I2C Error reading byte data. Address: '0x%02x', Return: -EOVERFLOW.  Attempt #%d / %d...\n", __func__, address, i, chip->numRetriesI2C); }
            else if (ret == -EPERM) { printk("fusb302 %s - I2C Error reading byte data. Address: '0x%02x', Return: -EPERM.  Attempt #%d / %d...\n", __func__, address, i, chip->numRetriesI2C); }
            else if (ret == -EPFNOSUPPORT) { printk("fusb302 %s - I2C Error reading byte data. Address: '0x%02x', Return: -EPFNOSUPPORT.  Attempt #%d / %d...\n", __func__, address, i, chip->numRetriesI2C); }
            else if (ret == -EPIPE) { printk("fusb302 %s - I2C Error reading byte data. Address: '0x%02x', Return: -EPIPE.  Attempt #%d / %d...\n", __func__, address, i, chip->numRetriesI2C); }
            else if (ret == -EPROTO) { printk("fusb302 %s - I2C Error reading byte data. Address: '0x%02x', Return: -EPROTO.  Attempt #%d / %d...\n", __func__, address, i, chip->numRetriesI2C); }
            else if (ret == -EPROTONOSUPPORT) { printk("fusb302 %s - I2C Error reading byte data. Address: '0x%02x', Return: -EPROTONOSUPPORT.  Attempt #%d / %d...\n", __func__, address, i, chip->numRetriesI2C); }
            else if (ret == -ERANGE) { printk("fusb302 %s - I2C Error reading byte data. Address: '0x%02x', Return: -ERANGE.  Attempt #%d / %d...\n", __func__, address, i, chip->numRetriesI2C); }
            else if (ret == -EREMCHG) { printk("fusb302 %s - I2C Error reading byte data. Address: '0x%02x', Return: -EREMCHG.  Attempt #%d / %d...\n", __func__, address, i, chip->numRetriesI2C); }
            else if (ret == -EREMOTE) { printk("fusb302 %s - I2C Error reading byte data. Address: '0x%02x', Return: -EREMOTE.  Attempt #%d / %d...\n", __func__, address, i, chip->numRetriesI2C); }
            else if (ret == -EREMOTEIO) { printk("fusb302 %s - I2C Error reading byte data. Address: '0x%02x', Return: -EREMOTEIO.  Attempt #%d / %d...\n", __func__, address, i, chip->numRetriesI2C); }
            else if (ret == -ERESTART) { printk("fusb302 %s - I2C Error reading byte data. Address: '0x%02x', Return: -ERESTART.  Attempt #%d / %d...\n", __func__, address, i, chip->numRetriesI2C); }
            else if (ret == -ESRCH) { printk("fusb302 %s - I2C Error reading byte data. Address: '0x%02x', Return: -ESRCH.  Attempt #%d / %d...\n", __func__, address, i, chip->numRetriesI2C); }
            else if (ret == -ETIME) { printk("fusb302 %s - I2C Error reading byte data. Address: '0x%02x', Return: -ETIME.  Attempt #%d / %d...\n", __func__, address, i, chip->numRetriesI2C); }
            else if (ret == -ETIMEDOUT) { printk("fusb302 %s - I2C Error reading byte data. Address: '0x%02x', Return: -ETIMEDOUT.  Attempt #%d / %d...\n", __func__, address, i, chip->numRetriesI2C); }
            else if (ret == -ETXTBSY) { printk("fusb302 %s - I2C Error reading byte data. Address: '0x%02x', Return: -ETXTBSY.  Attempt #%d / %d...\n", __func__, address, i, chip->numRetriesI2C); }
            else if (ret == -EUCLEAN) { printk("fusb302 %s - I2C Error reading byte data. Address: '0x%02x', Return: -EUCLEAN.  Attempt #%d / %d...\n", __func__, address, i, chip->numRetriesI2C); }
            else if (ret == -EUNATCH) { printk("fusb302 %s - I2C Error reading byte data. Address: '0x%02x', Return: -EUNATCH.  Attempt #%d / %d...\n", __func__, address, i, chip->numRetriesI2C); }
            else if (ret == -EUSERS) { printk("fusb302 %s - I2C Error reading byte data. Address: '0x%02x', Return: -EUSERS.  Attempt #%d / %d...\n", __func__, address, i, chip->numRetriesI2C); }
            else if (ret == -EWOULDBLOCK) { printk("fusb302 %s - I2C Error reading byte data. Address: '0x%02x', Return: -EWOULDBLOCK.  Attempt #%d / %d...\n", __func__, address, i, chip->numRetriesI2C); }
            else if (ret == -EXDEV) { printk("fusb302 %s - I2C Error reading byte data. Address: '0x%02x', Return: -EXDEV.  Attempt #%d / %d...\n", __func__, address, i, chip->numRetriesI2C); }
            else if (ret == -EXFULL) { printk("fusb302 %s - I2C Error reading byte data. Address: '0x%02x', Return: -EXFULL.  Attempt #%d / %d...\n", __func__, address, i, chip->numRetriesI2C); }
            else if (ret == -EOPNOTSUPP) { printk("fusb302 %s - I2C Error reading byte data. Address: '0x%02x', Return: -EOPNOTSUPP.  Attempt #%d / %d...\n", __func__, address, i, chip->numRetriesI2C); }
            else if (ret == -EPROBE_DEFER) { printk("fusb302 %s - I2C Error reading byte data. Address: '0x%02x', Return: -EPROBE_DEFER.  Attempt #%d / %d...\n", __func__, address, i, chip->numRetriesI2C); }
            else if (ret == -ENOENT) { printk("fusb302 %s - I2C Error reading byte data. Address: '0x%02x', Return: -ENOENT.  Attempt #%d / %d...\n", __func__, address, i, chip->numRetriesI2C); }
            else { printk("fusb302 %s - Unexpected I2C error reading byte data. Address: '0x%02x', Return: '%d'.  Attempt #%d / %d...\n", __func__, address, ret, i, chip->numRetriesI2C); }
        }
        else                                                                    // Successful i2c writes should always return 0
        {
            *data = (FSC_U8)ret;
...
FSC_BOOL fusb_I2C_ReadBlockData(FSC_U8 address, FSC_U8 length, FSC_U8* data)
{
    ...
    for (i = 0; i <= chip->numRetriesI2C; i++)
    {
        ...
        if (ret < 0)                                                                                    // Errors report as negative
        {
            if (ret == -ERANGE) { printk("fusb302 %s - I2C Error block reading byte data. Address: '0x%02x', Return: -ERANGE.  Attempt #%d / %d...\n", __func__, address, i, chip->numRetriesI2C); }
            else if (ret == -EINVAL) { printk("fusb302 %s - I2C Error block reading byte data. Address: '0x%02x', Return: -EINVAL.  Attempt #%d / %d...\n", __func__, address, i, chip->numRetriesI2C); }
            else if (ret == -EAGAIN) { printk("fusb302 %s - I2C Error block reading byte data. Address: '0x%02x', Return: -EAGAIN.  Attempt #%d / %d...\n", __func__, address, i, chip->numRetriesI2C); }
            else if (ret == -EALREADY) { printk("fusb302 %s - I2C Error block reading byte data. Address: '0x%02x', Return: -EALREADY.  Attempt #%d / %d...\n", __func__, address, i, chip->numRetriesI2C); }
            else if (ret == -EBADE) { printk("fusb302 %s - I2C Error block reading byte data. Address: '0x%02x', Return: -EBADE.  Attempt #%d / %d...\n", __func__, address, i, chip->numRetriesI2C); }
            else if (ret == -EBADMSG) { printk("fusb302 %s - I2C Error block reading byte data. Address: '0x%02x', Return: -EBADMSG.  Attempt #%d / %d...\n", __func__, address, i, chip->numRetriesI2C); }
            else if (ret == -EBUSY) { printk("fusb302 %s - I2C Error block reading byte data. Address: '0x%02x', Return: -EBUSY.  Attempt #%d / %d...\n", __func__, address, i, chip->numRetriesI2C); }
            else if (ret == -ECANCELED) { printk("fusb302 %s - I2C Error block reading byte data. Address: '0x%02x', Return: -ECANCELED.  Attempt #%d / %d...\n", __func__, address, i, chip->numRetriesI2C); }
            else if (ret == -ECOMM) { printk("fusb302 %s - I2C Error block reading byte data. Address: '0x%02x', Return: -ECOMM.  Attempt #%d / %d...\n", __func__, address, i, chip->numRetriesI2C); }
            else if (ret == -ECONNABORTED) { printk("fusb302 %s - I2C Error block reading byte data. Address: '0x%02x', Return: -ECONNABORTED.  Attempt #%d / %d...\n", __func__, address, i, chip->numRetriesI2C); }
            else if (ret == -ECONNREFUSED) { printk("fusb302 %s - I2C Error block reading byte data. Address: '0x%02x', Return: -ECONNREFUSED.  Attempt #%d / %d...\n", __func__, address, i, chip->numRetriesI2C); }
            else if (ret == -ECONNRESET) { printk("fusb302 %s - I2C Error block reading byte data. Address: '0x%02x', Return: -ECONNRESET.  Attempt #%d / %d...\n", __func__, address, i, chip->numRetriesI2C); }
            else if (ret == -EDEADLK) { printk("fusb302 %s - I2C Error block reading byte data. Address: '0x%02x', Return: -EDEADLK.  Attempt #%d / %d...\n", __func__, address, i, chip->numRetriesI2C); }
            else if (ret == -EDEADLOCK) { printk("fusb302 %s - I2C Error block reading byte data. Address: '0x%02x', Return: -EDEADLOCK.  Attempt #%d / %d...\n", __func__, address, i, chip->numRetriesI2C); }
            else if (ret == -EDESTADDRREQ) { printk("fusb302 %s - I2C Error block reading byte data. Address: '0x%02x', Return: -EDESTADDRREQ.  Attempt #%d / %d...\n", __func__, address, i, chip->numRetriesI2C); }
            else if (ret == -EFAULT) { printk("fusb302 %s - I2C Error block reading byte data. Address: '0x%02x', Return: -EFAULT.  Attempt #%d / %d...\n", __func__, address, i, chip->numRetriesI2C); }
            else if (ret == -EHOSTDOWN) { printk("fusb302 %s - I2C Error block reading byte data. Address: '0x%02x', Return: -EHOSTDOWN.  Attempt #%d / %d...\n", __func__, address, i, chip->numRetriesI2C); }
            else if (ret == -EHOSTUNREACH) { printk("fusb302 %s - I2C Error block reading byte data. Address: '0x%02x', Return: -EHOSTUNREACH.  Attempt #%d / %d...\n", __func__, address, i, chip->numRetriesI2C); }
            else if (ret == -EILSEQ) { printk("fusb302 %s - I2C Error block reading byte data. Address: '0x%02x', Return: -EILSEQ.  Attempt #%d / %d...\n", __func__, address, i, chip->numRetriesI2C); }
            else if (ret == -EINPROGRESS) { printk("fusb302 %s - I2C Error block reading byte data. Address: '0x%02x', Return: -EINPROGRESS.  Attempt #%d / %d...\n", __func__, address, i, chip->numRetriesI2C); }
            else if (ret == -EINTR) { printk("fusb302 %s - I2C Error block reading byte data. Address: '0x%02x', Return: -EINTR.  Attempt #%d / %d...\n", __func__, address, i, chip->numRetriesI2C); }
            else if (ret == -EIO) { printk("fusb302 %s - I2C Error block reading byte data. Address: '0x%02x', Return: -EIO.  Attempt #%d / %d...\n", __func__, address, i, chip->numRetriesI2C); }
            else if (ret == -ELIBACC) { printk("fusb302 %s - I2C Error block reading byte data. Address: '0x%02x', Return: -ELIBACC.  Attempt #%d / %d...\n", __func__, address, i, chip->numRetriesI2C); }
            else if (ret == -ELIBBAD) { printk("fusb302 %s - I2C Error block reading byte data. Address: '0x%02x', Return: -ELIBBAD.  Attempt #%d / %d...\n", __func__, address, i, chip->numRetriesI2C); }
            else if (ret == -ELIBMAX) { printk("fusb302 %s - I2C Error block reading byte data. Address: '0x%02x', Return: -ELIBMAX.  Attempt #%d / %d...\n", __func__, address, i, chip->numRetriesI2C); }
            else if (ret == -ELOOP) { printk("fusb302 %s - I2C Error block reading byte data. Address: '0x%02x', Return: -ELOOP.  Attempt #%d / %d...\n", __func__, address, i, chip->numRetriesI2C); }
            else if (ret == -EMSGSIZE) { printk("fusb302 %s - I2C Error block reading byte data. Address: '0x%02x', Return: -EMSGSIZE.  Attempt #%d / %d...\n", __func__, address, i, chip->numRetriesI2C); }
            else if (ret == -EMULTIHOP) { printk("fusb302 %s - I2C Error block reading byte data. Address: '0x%02x', Return: -EMULTIHOP.  Attempt #%d / %d...\n", __func__, address, i, chip->numRetriesI2C); }
            else if (ret == -ENOBUFS) { printk("fusb302 %s - I2C Error block reading byte data. Address: '0x%02x', Return: -ENOBUFS.  Attempt #%d / %d...\n", __func__, address, i, chip->numRetriesI2C); }
            else if (ret == -ENODATA) { printk("fusb302 %s - I2C Error block reading byte data. Address: '0x%02x', Return: -ENODATA.  Attempt #%d / %d...\n", __func__, address, i, chip->numRetriesI2C); }
            else if (ret == -ENODEV) { printk("fusb302 %s - I2C Error block reading byte data. Address: '0x%02x', Return: -ENODEV.  Attempt #%d / %d...\n", __func__, address, i, chip->numRetriesI2C); }
            else if (ret == -ENOLCK) { printk("fusb302 %s - I2C Error block reading byte data. Address: '0x%02x', Return: -ENOLCK.  Attempt #%d / %d...\n", __func__, address, i, chip->numRetriesI2C); }
            else if (ret == -ENOMEM) { printk("fusb302 %s - I2C Error block reading byte data. Address: '0x%02x', Return: -ENOMEM.  Attempt #%d / %d...\n", __func__, address, i, chip->numRetriesI2C); }
            else if (ret == -ENOMSG) { printk("fusb302 %s - I2C Error block reading byte data. Address: '0x%02x', Return: -ENOMSG.  Attempt #%d / %d...\n", __func__, address, i, chip->numRetriesI2C); }
            else if (ret == -ENOPROTOOPT) { printk("fusb302 %s - I2C Error block reading byte data. Address: '0x%02x', Return: -ENOPROTOOPT.  Attempt #%d / %d...\n", __func__, address, i, chip->numRetriesI2C); }
            else if (ret == -ENOSPC) { printk("fusb302 %s - I2C Error block reading byte data. Address: '0x%02x', Return: -ENOSPC.  Attempt #%d / %d...\n", __func__, address, i, chip->numRetriesI2C); }
            else if (ret == -ENOSYS) { printk("fusb302 %s - I2C Error block reading byte data. Address: '0x%02x', Return: -ENOSYS.  Attempt #%d / %d...\n", __func__, address, i, chip->numRetriesI2C); }
            else if (ret == -ENOTBLK) { printk("fusb302 %s - I2C Error block reading byte data. Address: '0x%02x', Return: -ENOTBLK.  Attempt #%d / %d...\n", __func__, address, i, chip->numRetriesI2C); }
            else if (ret == -ENOTTY) { printk("fusb302 %s - I2C Error block reading byte data. Address: '0x%02x', Return: -ENOTTY.  Attempt #%d / %d...\n", __func__, address, i, chip->numRetriesI2C); }
            else if (ret == -ENOTUNIQ) { printk("fusb302 %s - I2C Error block reading byte data. Address: '0x%02x', Return: -ENOTUNIQ.  Attempt #%d / %d...\n", __func__, address, i, chip->numRetriesI2C); }
            else if (ret == -ENXIO) { printk("fusb302 %s - I2C Error block reading byte data. Address: '0x%02x', Return: -ENXIO.  Attempt #%d / %d...\n", __func__, address, i, chip->numRetriesI2C); }
            else if (ret == -EOVERFLOW) { printk("fusb302 %s - I2C Error block reading byte data. Address: '0x%02x', Return: -EOVERFLOW.  Attempt #%d / %d...\n", __func__, address, i, chip->numRetriesI2C); }
            else if (ret == -EPERM) { printk("fusb302 %s - I2C Error block reading byte data. Address: '0x%02x', Return: -EPERM.  Attempt #%d / %d...\n", __func__, address, i, chip->numRetriesI2C); }
            else if (ret == -EPFNOSUPPORT) { printk("fusb302 %s - I2C Error block reading byte data. Address: '0x%02x', Return: -EPFNOSUPPORT.  Attempt #%d / %d...\n", __func__, address, i, chip->numRetriesI2C); }
            else if (ret == -EPIPE) { printk("fusb302 %s - I2C Error block reading byte data. Address: '0x%02x', Return: -EPIPE.  Attempt #%d / %d...\n", __func__, address, i, chip->numRetriesI2C); }
            else if (ret == -EPROTO) { printk("fusb302 %s - I2C Error block reading byte data. Address: '0x%02x', Return: -EPROTO.  Attempt #%d / %d...\n", __func__, address, i, chip->numRetriesI2C); }
            else if (ret == -EPROTONOSUPPORT) { printk("fusb302 %s - I2C Error block reading byte data. Address: '0x%02x', Return: -EPROTONOSUPPORT.  Attempt #%d / %d...\n", __func__, address, i, chip->numRetriesI2C); }
            else if (ret == -ERANGE) { printk("fusb302 %s - I2C Error block reading byte data. Address: '0x%02x', Return: -ERANGE.  Attempt #%d / %d...\n", __func__, address, i, chip->numRetriesI2C); }
            else if (ret == -EREMCHG) { printk("fusb302 %s - I2C Error block reading byte data. Address: '0x%02x', Return: -EREMCHG.  Attempt #%d / %d...\n", __func__, address, i, chip->numRetriesI2C); }
            else if (ret == -EREMOTE) { printk("fusb302 %s - I2C Error block reading byte data. Address: '0x%02x', Return: -EREMOTE.  Attempt #%d / %d...\n", __func__, address, i, chip->numRetriesI2C); }
            else if (ret == -EREMOTEIO) { printk("fusb302 %s - I2C Error block reading byte data. Address: '0x%02x', Return: -EREMOTEIO.  Attempt #%d / %d...\n", __func__, address, i, chip->numRetriesI2C); }
            else if (ret == -ERESTART) { printk("fusb302 %s - I2C Error block reading byte data. Address: '0x%02x', Return: -ERESTART.  Attempt #%d / %d...\n", __func__, address, i, chip->numRetriesI2C); }
            else if (ret == -ESRCH) { printk("fusb302 %s - I2C Error block reading byte data. Address: '0x%02x', Return: -ESRCH.  Attempt #%d / %d...\n", __func__, address, i, chip->numRetriesI2C); }
            else if (ret == -ETIME) { printk("fusb302 %s - I2C Error block reading byte data. Address: '0x%02x', Return: -ETIME.  Attempt #%d / %d...\n", __func__, address, i, chip->numRetriesI2C); }
            else if (ret == -ETIMEDOUT) { printk("fusb302 %s - I2C Error block reading byte data. Address: '0x%02x', Return: -ETIMEDOUT.  Attempt #%d / %d...\n", __func__, address, i, chip->numRetriesI2C); }
            else if (ret == -ETXTBSY) { printk("fusb302 %s - I2C Error block reading byte data. Address: '0x%02x', Return: -ETXTBSY.  Attempt #%d / %d...\n", __func__, address, i, chip->numRetriesI2C); }
            else if (ret == -EUCLEAN) { printk("fusb302 %s - I2C Error block reading byte data. Address: '0x%02x', Return: -EUCLEAN.  Attempt #%d / %d...\n", __func__, address, i, chip->numRetriesI2C); }
            else if (ret == -EUNATCH) { printk("fusb302 %s - I2C Error block reading byte data. Address: '0x%02x', Return: -EUNATCH.  Attempt #%d / %d...\n", __func__, address, i, chip->numRetriesI2C); }
            else if (ret == -EUSERS) { printk("fusb302 %s - I2C Error block reading byte data. Address: '0x%02x', Return: -EUSERS.  Attempt #%d / %d...\n", __func__, address, i, chip->numRetriesI2C); }
            else if (ret == -EWOULDBLOCK) { printk("fusb302 %s - I2C Error block reading byte data. Address: '0x%02x', Return: -EWOULDBLOCK.  Attempt #%d / %d...\n", __func__, address, i, chip->numRetriesI2C); }
            else if (ret == -EXDEV) { printk("fusb302 %s - I2C Error block reading byte data. Address: '0x%02x', Return: -EXDEV.  Attempt #%d / %d...\n", __func__, address, i, chip->numRetriesI2C); }
            else if (ret == -EXFULL) { printk("fusb302 %s - I2C Error block reading byte data. Address: '0x%02x', Return: -EXFULL.  Attempt #%d / %d...\n", __func__, address, i, chip->numRetriesI2C); }
            else if (ret == -EOPNOTSUPP) { printk("fusb302 %s - I2C Error reading byte data. Address: '0x%02x', Return: -EOPNOTSUPP.  Attempt #%d / %d...\n", __func__, address, i, chip->numRetriesI2C); }
            else if (ret == -EPROBE_DEFER) { printk("fusb302 %s - I2C Error reading byte data. Address: '0x%02x', Return: -EPROBE_DEFER.  Attempt #%d / %d...\n", __func__, address, i, chip->numRetriesI2C); }
            else if (ret == -ENOENT) { printk("fusb302 %s - I2C Error reading byte data. Address: '0x%02x', Return: -ENOENT.  Attempt #%d / %d...\n", __func__, address, i, chip->numRetriesI2C); }
            else { printk("fusb302 %s - Unexpected I2C error block reading byte data. Address: '0x%02x', Return: '%d'.  Attempt #%d / %d...\n", __func__, address, ret, i, chip->numRetriesI2C); }
        }
        else if (ret != length) // We didn't read everything we wanted
        {
            printk("fusb302 %s - Error: Block read request of %u bytes truncated to %u bytes.\n", __func__, length, I2C_SMBUS_BLOCK_MAX);
        }
        else
        {
...
void fusb_Delay10us(FSC_U32 delay10us)
{
    ...
    {
        printk(" fusb302 %s - Error: Delay of '%u' is too long! Must be less than '%u'.\n", __func__, delay10us, MAX_DELAY_10US);
        return;
    }
...
FSC_S32 fusb_get_pd_message_type(FSC_U16 header, FSC_U8* out)
{
    ...
    {
        printk(" fusb302 %s FUSB - Error: Invalid input buffer! header: 0x%x\n", __func__, header);
        return -1;
    }
...
static ssize_t _fusb_Sysfs_Hostcomm_show(struct device* dev, struct device_attribute* attr, char* buf)
{
    ...
    if (chip == NULL)
    {
        printk(" fusb302 %s - Chip structure is null!\n", __func__);
    }
    else if (buf == NULL || chip->HostCommBuf == NULL)
    {
        printk(" fusb302 %s - Buffer is null!\n", __func__);
    }
...
static ssize_t _fusb_Sysfs_Hostcomm_store(struct device* dev, struct device_attribute* attr, const char* input, size_t size)
{
    ...
    {
        printk(" fusb302 %s - Error: Input buffer is NULL!\n", __func__);
    }
    else
    {
        ...
        for (i = 0; i < size; i = i + j)
        {
            ...
            if (ret != 0)
            {
                printk(" fusb302 FUSB  %s - Error: Hostcomm input is not a valid hex value! Return: '%d'\n", __func__, ret);
...
void fusb_Sysfs_Init(void)
{
    ...
    if (ret)
    {
        printk(" fusb302 FUSB %s - Error creating sysfs attributes!\n", __func__);
    }
}
...
void fusb_InitializeCore(void)
{
    ...
    core_enable_typec(TRUE);
    printk("fusb302 FUSB  %s - Type-C State Machine is enabled!\n", __func__);
}
...
FSC_BOOL fusb_IsDeviceValid(void)
{
    ...
    {
        printk(" fusb302 FUSB  %s - Error: Could not communicate with device over I2C!\n", __func__);
        return FALSE;
    }
...
FSC_S32 fusb_EnableInterrupts(void)
{
    ...
    if (ret < 0)
    {
        printk("fusb302 %s - Error: Unable to request IRQ for INT_N GPIO! Error code: %d\n", __func__, ret);
        chip->gpio_IntN_irq = -1;   // Set to indicate error
        fusb_GPIO_Cleanup();
        return ret;
    }
    chip->gpio_IntN_irq = ret;
    printk("fusb302 %s - Success: Requested INT_N IRQ: '%d'\n", __func__, chip->gpio_IntN_irq);
    ...
    if (ret)
    {
        printk("fusb302 %s - Error: Unable to request threaded IRQ for INT_N GPIO! Error code: %d\n", __func__, ret);
        fusb_GPIO_Cleanup();
        return ret;
    }
...
{
    struct fusb30x_chip* chip = fusb30x_GetChip();
    printk("fusb302 FUSB  %s - Initializing threads!\n", __func__);
    if (!chip)
    {
        printk(" fusb302 FUSB  %s - Error: Chip structure is NULL!\n", __func__);
        return;
